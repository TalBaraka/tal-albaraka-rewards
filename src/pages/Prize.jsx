...
export default function Prize() {
  ...
  async function confirmPrize() {
    ...
    try {
      ...
      // يبدأ وقت الساعة من لحظة تأكيد استلام الجائزة فقط
      ...
      console.error(e);
      setError(
        e?.message || "تعذر تأكيد استلام الجائزة"
      );
    } finally {
      setConfirming(false);
    }
  ...
  const game = customer
    ? GAME_BY_KEY(customer.game_selected)
    : null;
        ...
        {game && (
          <div className="overflow-hidden rounded-3xl border border-amber-400/30 bg-slate-900 shadow-2xl">
            ...
            <div className="p-6 text-center">
              ...
              {!confirmed && (
                <>
                  ...
                  <button
                    ...
                    disabled={confirming}
                    className="mt-6 w-full rounded-2xl bg-gradient-to-r from-amber-400 to-yellow-500 px-6 py-5 text-xl font-black text-slate-950 shadow-lg transition hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {confirming
                      ? "جاري تأكيد الاستلام..."
              ...
              {confirmed && !expired && (
                <div className="mt-6 rounded-2xl border border-green-400/30 bg-green-400/10 p-6">
                  ...
                  <p className="mt-3 text-sm text-slate-400">
                    يبدأ احتساب الساعة من لحظة تأكيد الاستلام.
                  </p>
              ...
              {/* ================================================= */}
              {/* كلمة من إدارة تال البركة */}
              {/* ================================================= */}

              <div className="mt-10 rounded-3xl border border-amber-400/30 bg-gradient-to-b from-slate-800 to-slate-950 p-6 shadow-xl">

                <div className="mb-5 text-2xl font-black text-amber-300">
                  ❤️ كلمة من إدارة تال البركة
                </div>
                ...
                <div className="space-y-4 text-base leading-8 text-slate-200">
                  ...
                  <p>
                    ...
                    شكرًا لثقتكم الدائمة في
                    <span className="font-black text-white">
                      {" "}تال البركة
                    </span>
                    ، ونسعد دائمًا بوجودكم معنا.
                  </p>

                  <p>
                    مكافأتكم اليوم هي تقدير بسيط منّا
                    لثقتكم ودعمكم المستمر.
                  </p>

                  <p className="font-bold text-amber-200">
                    نتمنى لكم وقتًا سعيدًا وتجربة جميلة
                    مع جائزتكم 🎁✨
                  </p>
                ...
                <div className="mt-7 border-t border-slate-700 pt-6">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    رأيكم يهمنا ويسعدنا استقبال
                    ملاحظاتكم واقتراحاتكم.
                  </p>

                  <a
                    href="tel:0541001416"
                    className="mt-5 inline-flex items-center justify-center rounded-2xl bg-amber-400 px-7 py-4 text-lg font-black text-slate-950 shadow-lg transition hover:scale-105"
                  >
                    📞 0541001416
                  </a>
                ...
                <div className="mt-7 border-t border-slate-700 pt-5 text-xl font-black text-amber-300">
                  ثقتكم… مكافأتنا ❤️
                </div>
